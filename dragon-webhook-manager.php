...
// Plugin constants
define( 'DRAGONWEBHOOKMANAGER_VERSION', '1.0.14' );
...
require_once DRAGONWEBHOOKMANAGER_PLUGIN_DIR . 'includes/class-pro-pointer.php';
...
function dragonwebhookmanager_init(): void {
	$dragonwebhookmanager_plugin = Plugin::get_instance();
